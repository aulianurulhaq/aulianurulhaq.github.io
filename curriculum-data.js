...
const CURRICULUM_DATA = [
  {
    ...
    description: "Memahami sistem bilangan Desimal, Biner, Oktal, dan Heksadesimal dengan metode Biner Sentral sebagai jembatan konversi utama.",
    objectives: [
    ...
    submenus: [
      { id: "w1-konsep", title: "Konsep & Teori Biner Sentral", icon: "book-open" },
      { id: "w1-simulator", title: "Simulator Konversi Sentral", icon: "cpu" },
      { id: "w1-visualizer", title: "Visualisator Pengelompokan Bit", icon: "layers" },
      { id: "w1-switcher", title: "Playground Saklar Bit", icon: "sliders" },
      { id: "w1-kuis", title: "Latihan & Kuis Interaktif", icon: "check-circle" }
    ]
  },
  {
    id: "week2",
    ...
    status: "upcoming",
    category: "Fondasi Digital",
    description: "Studi mendalam tentang representasi data digital, binary codes, serta penanganan bilangan bertanda pada sistem komputasi.",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w2-m3", title: "Bilangan Bertanda & 2's Complement", icon: "file-text" },
  ...
  },
  {
    ...
    description: "Dasar-dasar matematis penyederhanaan fungsi biner menggunakan postulat Huntington dan teorema De Morgan.",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w3-m2", title: "Hukum De Morgan & Teorema Logika", icon: "file-text" },
      { id: "w3-m3", title: "Bentuk Kanonik: Minterm (SOP) & Maxterm (POS)", icon: "file-text" }
    ]
  },
  {
    id: "week4",
    ...
    status: "upcoming",
    category: "Logika Kombinasional",
    description: "Analisis perangkat keras gerbang logika standar dan implementasi gerbang universal NAND/NOR untuk membuat fungsi apapun.",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w4-m2", title: "Gerbang Turunan: NAND, NOR, XOR, XNOR", icon: "file-text" },
      { id: "w4-m3", title: "Implementasi Universal Gate (NAND & NOR)", icon: "file-text" },
      { id: "w4-m4", title: "Laboratorium Simulasi Gerbang Virtual", icon: "cpu" }
    ]
  },
  {
    id: "week5",
    ...
    status: "upcoming",
    category: "Logika Kombinasional",
    description: "Teknik grafis Karnaugh Map (K-Map) untuk meminimalkan fungsi logika hingga 4 variabel dengan efisien.",
    objectives: [
    ...
    submenus: [
      { id: "w5-m1", title: "Prinsip Dasar Gray Code pada K-Map", icon: "file-text" },
      { id: "w5-m2", title: "Penyederhanaan K-Map 2 & 3 Variabel", icon: "file-text" },
      { id: "w5-m3", title: "Penyederhanaan K-Map 4 Variabel", icon: "file-text" },
      { id: "w5-m4", title: "Penanganan Kondisi Don't Care (X)", icon: "file-text" }
    ]
  },
  {
    id: "week6",
    ...
    description: "Perancangan rangkaian penambah dan pengurang biner sebagai pondasi Arithmetic Logic Unit (ALU).",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w6-m2", title: "Half Subtractor & Full Subtractor", icon: "file-text" },
      { id: "w6-m3", title: "Parallel Binary Adder 4-bit", icon: "file-text" },
      { id: "w6-m4", title: "Rangkaian Gabungan Adder-Subtractor 2's Complement", icon: "file-text" }
    ]
  },
  {
    id: "week7",
    ...
    description: "Pemilih data (MUX) dan penyalur data (DEMUX) skala menengah (Medium Scale Integration).",
    objectives: [
    ...
    submenus: [
      { id: "w7-m1", title: "Arsitektur Multiplexer (2:1, 4:1, 8:1)", icon: "file-text" },
      { id: "w7-m2", title: "Implementasi Fungsi Logika dengan MUX", icon: "file-text" },
      { id: "w7-m3", title: "Demultiplexer (1:2, 1:4, 1:8)", icon: "file-text" },
  ...
  },
  {
    ...
    status: "upcoming",
    category: "Komponen MSI",
    description: "Konversi kode perangkat keras, driver tampilan seven segment, serta pemantapan materi persiapan UTS.",
    objectives: [
    ...
    submenus: [
      { id: "w8-m1", title: "Decoder Biner & BCD to 7-Segment", icon: "file-text" },
      { id: "w8-m2", title: "Encoder & Priority Encoder", icon: "file-text" },
      { id: "w8-m3", title: "Simulasi Tampilan Digital Seven Segment", icon: "cpu" },
      { id: "w8-m4", title: "Review Komprehensif & Bank Soal UTS", icon: "check-circle" }
    ]
  },
  {
    id: "week9",
    ...
    description: "Elemen penyimpan memori 1-bit, transisi picuan tepi (edge-triggered), dan perbandingan jenis-jenis Flip-Flop.",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w9-m4", title: "T Flip-Flop & Pembagi Frekuensi", icon: "file-text" }
    ]
  },
  {
    id: "week10",
    ...
    status: "upcoming",
    category: "Logika Sekuensial",
    description: "Perancangan pencacah naik/turun berbasis Flip-Flop baik secara asinkron (ripple) maupun sinkron.",
    objectives: [
    ...
    submenus: [
      ...
      { id: "w10-m3", title: "Perancangan Modulo-N Counter", icon: "file-text" },
      { id: "w10-m4", title: "Studi Kasus: Desain Jam Digital BCD", icon: "cpu" }
    ]
  },
  {
    id: "week11",
    ...
    status: "upcoming",
    category: "Logika Sekuensial",
    description: "Penyimpanan data multi-bit dan konversi transmisi data serial-paralel.",
    objectives: [
    ...
    submenus: [
      { id: "w11-m1", title: "Buffer Register & Penyimpan Data", icon: "file-text" },
      { id: "w11-m2", title: "Klasifikasi 4 Mode Shift Register", icon: "file-text" },
      { id: "w11-m3", title: "Universal Shift Register (IC 74194)", icon: "file-text" },
      { id: "w11-m4", title: "Ring Counter & Johnson Counter", icon: "file-text" }
    ]
  },
  {
    id: "week12",
    ...
    description: "Pemodelan sistem logika sekuensial terstruktur menggunakan Finite State Machine model Mealy dan Moore.",
    objectives: [
    ...
    submenus: [
      { id: "w12-m1", title: "Konsep Dasar & Pemodelan State", icon: "file-text" },
      { id: "w12-m2", title: "Model Mealy vs Model Moore", icon: "file-text" },
      { id: "w12-m3", title: "Perancangan Pendeteksi Urutan (Sequence Detector)", icon: "file-text" },
      { id: "w12-m4", title: "Studi Kasus: Pengendali Lampu Lalu Lintas Otomatis", icon: "cpu" }
    ]
  },
  {
    id: "week13",
    ...
    description: "Teknologi penyimpanan data semikonduktor serta pengenalan perangkat keras yang dapat diprogram (PLD, FPGA).",
    objectives: [
    ...
    submenus: [
      { id: "w13-m1", title: "Arsitektur RAM (SRAM vs DRAM)", icon: "file-text" },
      { id: "w13-m2", title: "Arsitektur ROM & Pemetaan Alamat (Address Decoding)", icon: "file-text" },
      { id: "w13-m3", title: "Perangkat Logika Terprogram: PLA, PAL, CPLD", icon: "file-text" },
      { id: "w13-m4", title: "Pengantar FPGA & Alur Desain HDL", icon: "file-text" }
    ]
  },
  {
    id: "week14",
    ...
    description: "Integrasi seluruh komponen sistem digital ke dalam arsitektur mikrokomputer sederhana dan persiapan komprehensif UAS.",
    objectives: [
    ...
    submenus: [
      { id: "w14-m1", title: "Arsitektur Data Path & Simple CPU Model", icon: "cpu" },
      { id: "w14-m2", title: "Showcase Proyek Praktikum Mandiri", icon: "file-text" },
      { id: "w14-m3", title: "Simulasi Uji Kompetensi Sistem Digital", icon: "check-circle" },
      { id: "w14-m4", title: "Bank Soal Latihan & Panduan UAS", icon: "book-open" }
    ]
  }
];
